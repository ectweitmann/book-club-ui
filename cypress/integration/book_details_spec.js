describe('Book Club book details page user flow', () => {
  ...
  it('should allow a user to add book to favorites', () => {
    cy.intercept('GET', 'https://book-club-api-2110.herokuapp.com/api/v1/books/9780525559474', { fixture: 'singleBook.json' })
    ...
    cy.intercept('GET', 'https://book-club-api-2110.herokuapp.com/api/v1/favorites', { fixture: 'singleFavoritedBook.json' })
    cy.visit('http://localhost:3000/9780525559474/selectedBook')
